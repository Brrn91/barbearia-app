...
router.put('/servicos/:id', autenticarAdmin, servicoController.atualizarServico);
router.patch('/servicos/:id/desativar', autenticarAdmin, servicoController.desativarServico);
...
router.get('/agendamentos', autenticarAdmin, agendamentoController.listarAgendamentos);
router.patch('/agendamentos/:id/cancelar', autenticar, agendamentoController.cancelarAgendamento);
